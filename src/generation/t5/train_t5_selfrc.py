...
if __name__ == '__main__':
    ...
    train_contexts, train_questions, train_answers = read_dataset('dataset/train_set.csv')
    val_contexts, val_questions, val_answers = read_dataset('dataset/eval_set.csv')
    dataset = {}
