...
# Multidoc2dial
train_df = pd.read_csv("data/dataset/train_set.csv", sep="\t").astype(str)
eval_df = pd.read_csv("data/dataset/eval_set.csv", sep="\t").astype(str)
train_df = train_df.rename(
    columns={"question+grounding": "input_text", "utterance": "target_text"}
)
...
##
# # Google Data
# train_df1 = pd.read_csv("data/train.tsv", sep="\t").astype(str)
# eval_df1 = pd.read_csv("data/dev.tsv", sep="\t").astype(str)

# train_df1 = train_df.loc[train_df["label"] == "1"]
# eval_df1 = eval_df.loc[eval_df["label"] == "1"]

# train_df1 = train_df.rename(
#     columns={"sentence1": "input_text", "sentence2": "target_text"}
# )
# eval_df1 = eval_df.rename(
#     columns={"sentence1": "input_text", "sentence2": "target_text"}
# )

# train_df1 = train_df[["input_text", "target_text"]]
# eval_df1 = eval_df[["input_text", "target_text"]]

# train_df1["prefix"] = "paraphrase"
# eval_df1["prefix"] = "paraphrase"


# train_df = pd.concat(train_df, train_df1)
# eval_df = pd.concat(eval_df, eval_df1)
